...
mod tests {
    ...
    fn blockquote() {
        ...
        assert_eq!(
            ...
            from_str::<MessageEntity>(r#"{"type":"blockquote","offset":32,"length":92}"#).unwrap()
        );
    }
    ...
    fn expandable_blockquote() {
        ...
        assert_eq!(
            ...
            from_str::<MessageEntity>(
                r#"{"type":"expandable_blockquote","offset":0,"length":311}"#
            )
            .unwrap()
        );
    }
    ...
    fn unknown_kind() {
        ...
        assert_eq!(
            MessageEntity {
                kind: MessageEntityKind::Unknown,
                offset: 5,
                length: 10,
            },
            from_str::<MessageEntity>(r#"{"type":"future_unknown_entity","offset":5,"length":10}"#).unwrap()
        );
    }
