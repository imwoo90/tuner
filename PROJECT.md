...
| 4 | Telegram bot formatting | Text formatters, HTML escaping, formatting tests | none | DONE |
| 5 | Telegram commands & replies | Commands (/new, /reset, etc.), reply helper | M4, M3 | IN_PROGRESS |
